...
int main ()
{
    ...
    int iRmin = 0, iRmax = 39, iVmin = 60, iVmax = 255, iBmin = 0, iBmax = 255; // Vert
    	...
    	for (int i = 0; i< contours.size(); i++)
	    {
            ...
            if (area > 1500 )
            {
                ...
                {                       
                    ...
                    putText(imgOri, "Feu Vert", {boundRect[i].x, boundRect[i].y}, FONT_ITALIC, 1, Scalar(0,255,0), 2);
